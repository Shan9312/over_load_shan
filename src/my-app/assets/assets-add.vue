        ...
        <el-row class="basic-panel">
          ...
          <el-col :span="8">
            <el-form-item label="资产编号" >
              <el-input  v-model="assetCode"  type="text"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
export default {
  ...
  methods: {
     ...
     * */
    isCheckedPosition() {
      this.depListHasPosition(this.positionList.id, this.deptTree);
    },
    /**
     * 获得选中的职能
     *
