      ...
      <el-col :span="12" class="p-r-10">
        <div v-content-inline>
          ...
          <el-scrollbar tag="div"  >
            ...
            <infinite-collapse :data="depList"></infinite-collapse>
            <img
        ...
        <div v-content-inline>
          ...
          <el-scrollbar tag="div" >
            ...
            {{item.name}}
              ...
              <item-tag-ui :num="item.relationProject"></item-tag-ui>
      ...
      <el-col :span="12" class="related-project">
        <div v-content-inline>
          ...
          <el-scrollbar tag="div">
            ...
            <div class="item-li" v-for="(item,index) in result.companyList" :key="index">
                  <span class="title">
                    {{item.name}}
                  </span>
              <child-tag-ui :num="item.relationProject"></child-tag-ui>
              <span class="control m-r-25">
                    <router-link :to="{name:'crmDetails',params:{id:item.id}}">
                      <el-button  plain>前往</el-button>
                    </router-link>
  ...
  * */
  ...
  methods: {
    ...
    * */
     ...
     * */
    goEdit() {
      this.$router.push({ name: 'projectEdit', params: this.id });
    },
    /**
     * 数据解构更换
     *
